...
llumnix_plus = [2, 5, 8, 15, 26, 40, 75, 86, 92, 93, 94, 98, 100] #(a good result for SLO=0.25s, 90% reqs were within the SLO.)
...
llumnix = [9, 15, 22, 29, 40, 49, 53, 58, 63, 90, 100, 100, 100] #(a good result for SLO=0.25s, 90% reqs were within the SLO for exhaustive.)
...
plt.axvline(x = 2.4, color = 'green', linestyle = '--', linewidth = 2)
plt.axhline(y = 0.9, color = color_list[0], linestyle = '--', linewidth = 2)
plt.axhline(y = 0.615, color = color_list[1], linestyle = '--', linewidth = 2)
