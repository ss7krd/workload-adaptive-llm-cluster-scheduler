...
dummy_1 = [98,64,84.6]#write each method's TTFT here.
dummy = [0,0,0]
dummy_2 = [97.9,97.8,97.6]#write each method's TBT here.
...
# plt.xticks(xvalues)
# plt.xticks(xvalues)
system_names = ["AdaGen", "Round-robin", "Llumnix++"]
...
ax.set_position([box.x0 + box.width*0.09, box.y0 + box.height*0.3, box.width*0.9, box.height*0.65])
