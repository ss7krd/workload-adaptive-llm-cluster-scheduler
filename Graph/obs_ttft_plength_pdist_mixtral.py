...
dummy_1 = [0.34,0.34,0.33] #TTFT
dummy_1 = [2.76, 2.75, 2.765] #TTFT-final
dummy = [0,0,0]
# dummy_2 = [0.283,0.323,0.314] #TBT
# 0.332,0.32,0.328
dummy_2 = [0.332,0.32,0.328]
dummy_2 = [2.745, 2.72, 2.744] #TTFT-final
dummy_3 = [0.321,0.311,0.320]
dummy_3 = [2.736, 2.709, 2.731] #TTFT-final
...
ax.bar(ind,dummy,width,color=color_list[0],edgecolor=color_list[0],hatch='+',fill=False,label="Llumnix",linewidth=2)
ax.bar(ind,dummy,width,color=color_list[1],edgecolor=color_list[1],hatch='',fill=True,label="Llumnix+\nPL-aware",linewidth=2)
ax.bar(ind, dummy, width, color = color_list[3], hatch='*',edgecolor = color_list[3],fill=False,label="Llumnix+\nPLD-aware",linewidth=2)
...
ax.bar(ind+1*width, dummy_2, width, color = color_list[1], hatch='',edgecolor = color_list[1],fill=True,linewidth=2)
ax.bar(ind+2*width, dummy_3, width, color = color_list[3], hatch='*',edgecolor = color_list[3],fill=False,linewidth=2)
...
# plt.xticks(xvalues)
# plt.xticks(xvalues)
system_names = ["Subset1", "Subset2", "Subset3"]
...
ax.set_position([box.x0 + box.width*0.05, box.y0 + box.height*0.15, box.width, box.height*0.55])
#bbox_to_anchor=(0.5, 1.6)
leg = ax.legend(loc='upper center', bbox_to_anchor=(0.5, 1.98), handler_map={matplotlib.lines.Line2D: SymHandler()}, 
            fontsize='60', ncol=2, handleheight=1, labelspacing=0.35, frameon=False) 
