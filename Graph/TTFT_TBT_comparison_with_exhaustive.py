...
system_ttft=[90, 90, 100]
exhaustive_ttft=[95, 95, 100]
# llumnix_ttft=[76.6, 79.8, 73.9]

system_tbt=[90.1, 88.3, 87.9]
exhaustive_tbt=[92.1, 91.3, 92.3]
# llumnix_tbt=[90.2, 88.2, 87.12]

#BAAD.
system_totalTime=[0, 0, 0]
exhaustive_totalTime=[12, 12, 12]
# llumnix_tbt=[90.2, 88.2, 87.12]
# stepX=[1,2,3,4,5,6]
...
ax[0].bar(ind,system_ttft,width,color=color_list[0],hatch='+',edgecolor=color_list[0],fill=False,linewidth=2)
ax[0].bar(ind+1*width,exhaustive_ttft,width,color=color_list[1],edgecolor=color_list[1],hatch='',fill=True,linewidth=2)
# ax[0].bar(ind+2*width,llumnix_ttft,width,color=color_list[3],hatch='*',edgecolor=color_list[3],fill=False,linewidth=2)
...
ax[0].bar(ind,dummy,width,color=color_list[0],edgecolor=color_list[0],hatch='+',fill=False,label="AdaGen",linewidth=2)
ax[0].bar(ind,dummy,width,color=color_list[1],edgecolor=color_list[1],hatch='',fill=True,label="Exhaustive",linewidth=2)
# ax[0].bar(ind,dummy,width,color=color_list[3],edgecolor=color_list[3],hatch='*',fill=False,label="Llumnix++",linewidth=2)

ax[1].bar(ind,system_tbt,width,color=color_list[0],hatch='+',edgecolor=color_list[0],fill=False,linewidth=2)
ax[1].bar(ind+1*width,exhaustive_tbt,width,color=color_list[1],edgecolor=color_list[1],hatch='',fill=True,linewidth=2)

# ax[2].bar(ind,system_totalTime,width,color=color_list[0],hatch='+',edgecolor=color_list[0],fill=False,linewidth=2)
# ax[2].bar(ind+1*width,exhaustive_totalTime,width,color=color_list[1],edgecolor=color_list[1],hatch='',fill=True,linewidth=2)
# ax[1].bar(ind+2*width,llumnix_tbt,width,color=color_list[3],hatch='*',edgecolor=color_list[3],fill=False,linewidth=2)
...
ax[0].set_title('TTFT', fontsize=60, y=1.05)
ax[1].set_title('TBT', fontsize=60)
# ax[1].set_title('Total execution time', fontsize=60)
# ax[2].set_title('AlpaServe', fontsize=40)

# ax[0].set_ylabel('Utilization')
fig.text(0.01,0.45, 'SLO attainment', va = 'center', rotation = "vertical", fontsize=60)
...
xvalues = ["Llama3-8B","Mixtral","Llama3-70B"]

# ax[0].set_yticks([50, 100])
# ax[1].set_yticks([50, 100])
# ax[2].set_yticks([50, 75, 100])
ax[0].set_yticks([25, 100])
ax[1].set_yticks([25, 100])
yvalues = ["25%", "100%"]
...
ax[1].set_xticklabels(xvalues, rotation=20)
...
#box.height*0.75
#box.y0 + box.height * 0.32
ax[1].set_position([box.x0 + box.width*0.1, box.y0 + box.height*0.4, box.width*0.9, box.height*0.5])


box = ax[0].get_position()
#box.height*0.75
#box.y0 + box.height * 0.32
ax[0].set_position([box.x0 + box.width*0.1, box.y0 + box.height*0.08, box.width*0.9, box.height*0.5])
#bbox_to_anchor=(0.5, 1.6)
leg = ax[0].legend(loc='upper center', bbox_to_anchor=(0.45, 2.8), handler_map={matplotlib.lines.Line2D: SymHandler()}, 
