...
dummy_1 = [0.24,0.39,0.32] #TTFT
dummy_1 = [0.17,0.32,0.25] #TTFT-final
dummy = [0,0,0]
dummy_2 = [0.11,0.11,0.11] #TBT
dummy_2 = [0.09,0.09,0.09] #TBT-final
...
ax.set_position([box.x0 + box.width*0.05, box.y0 + box.height*0.3, box.width, box.height*0.65])
