...
# [100,100,96,91.2,86.1]
our_system = [100,100,96,91.2,86.1]
ax.plot(stepX,np.array(our_system),c=color_list[0],marker="x", mew=4, markersize=26,ls='-',label="AdaGen",fillstyle='none', linewidth = 4)

# plt.axvline(x = 85, color = color_list[0], linestyle = '--', linewidth = 2)
...
# 8, 16, 32, 64, 128, 256
round_robin = [72,68,59,41.6,23.8]
# ax.plot(stepX, np.array(static)-5, c = 'blue', marker = 'o', markersize = 26, ls = '-', label = "Scrooge", fillstyle = 'full', linewidth = 4)
ax.plot(stepX, np.array(round_robin), c =color_list[1], marker = 's', mew=5, markersize = 26, ls = '-', label = "Round-robin", fillstyle = 'none', linewidth = 4)

llumnix = [93.4,91.3,76.6,55.1,45.2]
# ax.plot(stepX, np.array(static)-5, c = 'blue', marker = 'o', markersize = 26, ls = '-', label = "Scrooge", fillstyle = 'full', linewidth = 4)
ax.plot(stepX, np.array(llumnix), c = color_list[3], marker = 'o', mew=4, markersize = 26, ls = '-', label = "Llumnix++", fillstyle = 'none', linewidth = 4)

# plt.axhline(y = 90, color = 'green', linestyle = '--', linewidth = 2)

# alpaserve = [8,16,21.3,21.3,21.3]
# ax.plot(stepX, np.array(static)-5, c = 'blue', marker = 'o', markersize = 26, ls = '-', label = "Scrooge", fillstyle = 'full', linewidth = 4)
...
ax.set_position([box.x0 + box.width*0.1, box.y0 + box.height*0.09, box.width*0.95, box.height*0.75])
