...
#[0.384,0.327,0.31,0.252]
dummy_1 = [3.69,3.19,3.14,2.78] #TTFT
dummy_1 = [3.32,2.82,2.77,2.3] #TTFT-final
dummy = [0,0,0,0]
dummy_2 = [0.367,0.367,0.367,0.367] #TBT
dummy_2 = [0.14, 0.14, 0.14, 0.14] #TBT-final
...
ax.bar(ind,dummy,width,color=color_list[0],edgecolor=color_list[0],hatch='+',fill=False,label="TTFT",linewidth=2)
ax.bar(ind,dummy,width,color=color_list[1],edgecolor=color_list[1],hatch='',fill=True,label="TBT",linewidth=2)
...
# plt.xticks(xvalues)
# plt.xticks(xvalues)
system_names = ["Round-Robin", "Round-Robin+\nSD", "Llumnix", "Llumnix+\nSD"]
...
ax.set_position([box.x0 + box.width*0.05, box.y0 + box.height*0.35, box.width, box.height*0.60])
#bbox_to_anchor=(0.5, 1.6)
leg = ax.legend(loc='upper center', bbox_to_anchor=(0.5, 1.4), handler_map={matplotlib.lines.Line2D: SymHandler()}, 
