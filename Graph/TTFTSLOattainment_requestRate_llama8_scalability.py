...
our_system = [100,98.4,95.3,88.1,86.1]
...
# 8, 16, 32, 64, 128, 256
round_robin = [74,68,59,35.6,23.8]
# ax.plot(stepX, np.array(static)-5, c = 'blue', marker = 'o', markersize = 26, ls = '-', label = "Scrooge", fillstyle = 'full', linewidth = 4)
ax.plot(stepX, np.array(round_robin)-2.5, c =color_list[1], marker = 's', mew=5, markersize = 26, ls = '-', label = "Round-robin", fillstyle = 'none', linewidth = 4)

llumnix = [91.1,82.3,75.4,59.1,48.2]
# ax.plot(stepX, np.array(static)-5, c = 'blue', marker = 'o', markersize = 26, ls = '-', label = "Scrooge", fillstyle = 'full', linewidth = 4)
...
ax.set_position([box.x0 + box.width*0.1, box.y0 + box.height*0.09, box.width*0.9, box.height*0.75])
