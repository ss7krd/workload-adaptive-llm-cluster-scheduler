...
ax.bar([0,1.5,3,4.5], dummy, width, color=color_list[2],hatch='x',edgecolor=color_list[2],fill=False,linewidth=2)
# ax.errorbar([0,1.5,3,4.5,6], dummy, yerr = [[0.15,0.14,0.16,0.17,0.18],[0.19,0.2,0.21,0.2,0.22]], fmt='o', color='black', capsize=5, elinewidth=2, capthick=2)
...
xvalues = ["Round-Robin", "PDLD", "PDLD+SD", "AdaGen\n(PDLD+SD+\nOR)"]
ax.set_xticklabels(xvalues, rotation=30)
...
ax.set_position([box.x0 + box.width*0.09, box.y0 + box.height*0.4, box.width*0.95, box.height*0.6])
