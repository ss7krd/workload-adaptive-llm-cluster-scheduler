...
exhaustive = [2, 3, 6, 21, 28, 43, 71, 90, 91, 91, 91, 95, 100] #(a good result for SLO=0.25s, 90% reqs were within the SLO.)
...
llumnix = [9, 10, 22, 33, 41, 47, 53, 55, 70, 94, 100, 100, 100] #(a good result for SLO=0.25s, 90% reqs were within the SLO for exhaustive.)
llumnix = [9, 10, 22, 33, 41, 47, 53, 55, 70, 83, 91, 100, 100]
llumnix = [0.1, 0.1, 0.2, 0.3, 0.4, 0.4, 0.4, 0.4, 0.5, 0.6, 0.7, 1, 1]#prev-wrong-right
# ax.plot(stepX, np.array(static)-5, c = 'blue', marker = 'o', markersize = 26, ls = '-', label = "Scrooge", fillstyle = 'full', linewidth = 4)
ax.plot(stepX, np.array(llumnix), c = color_list[1], ls = '-.', label = "Llumnix", fillstyle = 'none', linewidth = 4)
