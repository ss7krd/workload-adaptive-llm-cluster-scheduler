...
ax.set_position([box.x0 + box.width*0.05, box.y0 + box.height*0.2, box.width, box.height*0.65])
#bbox_to_anchor=(0.5, 1.6)
leg = ax.legend(loc='upper center', bbox_to_anchor=(0.5, 1.5), handler_map={matplotlib.lines.Line2D: SymHandler()}, 
